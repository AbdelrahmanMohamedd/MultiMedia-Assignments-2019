...
public class Huffman {
    ...
    public static void CreateTree(Node root, Node last) {
    ...
    public static void mycompress(ArrayList<String> tags) throws IOException {
        ...
        System.out.println("Charachter and its count");
        for (int i = 0; i < countOfcharacters.length; i++) {
        ...
        System.out.println("Here After Sorting them....");
        ...
        CreateTree(root, last);
        FileWriter myff = new FileWriter("Decompression.txt");
